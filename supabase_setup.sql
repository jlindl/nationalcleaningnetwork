...
begin
  ...
  values (
    ...
    -- Handle array casting for serviceTypes if possible, or store as JSONB then cast, 
    -- but user_meta_data is JSONB, so we can extract array.
    -- Ideally, frontend sends array. supabase-js sends it as JSON array in metadata.
