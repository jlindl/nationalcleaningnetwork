...
drop policy if exists "Anyone can insert onboarding leads" on public.onboarding_leads;
create policy "Anyone can insert onboarding leads"
on public.onboarding_leads for insert
with check (true);

drop policy if exists "Anyone can update onboarding leads by ID" on public.onboarding_leads;
create policy "Anyone can update onboarding leads by ID"
